    ...
    <div>
      <div className="dossier">
        ...
        <div className="case-file">
          ...
          <div className="charge">CHARGE: {p.id === 'skogix' ? 'CHRONIC FEEDING' : p.id === 'zcope' ? 'COPING IN PUBLIC' : p.id === 'nagasaki' ? 'BRAVE BOY SYNDROME' : p.id === 'karasu' ? 'RESERVE FRAUD' : 'CARRYING DEAD WEIGHT'}</div>
